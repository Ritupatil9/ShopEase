...
<body>
  ...
  <nav class="navbar d-flex justify-content-between align-items-center">
    ...
    <div class="nav-actions">
      ...
      <a href="#" id="cart-link"><i class="fa fa-shopping-cart"></i> Cart</a>
      <a href="login.php">Login</a>
      <a href="admin-login.php">Admin Login</a>  <!-- Added Admin Login link -->
  ...
  <div class="container shop-section py-5" id="shop">
    ...
    <div class="category-grid">
      <div class="category-box col-md-3">
        ...
        <a href="" class="see-more-btn">Shop Clothes</a>
      </div>
      <div class="category-box col-md-3">
        <h5>Health & Wellness</h5>
        <div class="box-img" style="background-image: url('images/box2_image.jpg');"></div>
        <a href="" class="see-more-btn">Explore Health</a>
      </div>
      <div class="category-box col-md-3">
        <h5>Furniture</h5>
        <div class="box-img" style="background-image: url('images/download.jpeg');"></div>
        <a href="" class="see-more-btn">Browse Furniture</a>
      </div>
      <div class="category-box col-md-3">
        <h5>Mobiles</h5>
        <div class="box-img" style="background-image: url('images/box4_image.jpg');"></div>
        <a href="#" class="see-more-btn">View Mobiles</a>
      </div>
      <div class="category-box col-md-3">
        <h5>Electronics</h5>
        <div class="box-img" style="background-image: url('images/Electronics.jpg');"></div>
        <a href="#" class="see-more-btn">Shop Electronics</a>
      </div>
      <div class="category-box col-md-3">
        <h5>Beauty</h5>
        <div class="box-img" style="background-image: url('images/box5_image.jpg');"></div>
        <a href="#" class="see-more-btn">Beauty Picks</a>
      </div>
      <div class="category-box col-md-3">
        <h5>Home Decor</h5>
        <div class="box-img" style="background-image: url('images/home.jpg');"></div>
        <a href="#" class="see-more-btn">Style Your Space</a>
      </div>
      <div class="category-box col-md-3">
        <h5>Toys & Games</h5>
        <div class="box-img" style="background-image: url('images/box7_image.jpg');"></div>
        <a href="#" class="see-more-btn">Fun & Games</a>
      </div>
    </div>
  </div>
  ...
  <script>
    document.getElementById('cart-link').addEventListener('click', function (event) {
      ...
      // Check if the user is logged in (simple example with a prompt)
      const isLoggedIn = false; // Modify this logic as per your actual user authentication

      if (!isLoggedIn) {
        // If not logged in, prompt to log in or sign up
        alert('Please log in or sign up to access your cart.');
        window.location.href = 'login.php'; // Redirect to login page
      } else {
        // If logged in, allow access to cart
        window.location.href = 'cart.php'; // Redirect to cart page (adjust the URL as needed)
      }
    });
  </script>
